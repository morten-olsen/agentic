...
import { projectSchema, goalSchema } from '../../domain/user-model/user-model.schemas.ts';
import { locationSchema } from '../../domain/location/location.schemas.ts';
import { calendarEventSchema } from '../../domain/calendar/calendar.schemas.ts';

import type { ToolRegistry, RegisteredTool } from '../../agent/tools/tools.ts';
import type { SkillDefinition } from '../../agent/skills/skills.schemas.ts';
import { getHealthDataTool, getSleepSummaryTool } from '../../integrations/health/health.tools.ts';

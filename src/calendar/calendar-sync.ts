...
import type { HomeAssistantClient } from '../external/homeassistant/homeassistant.ts';
import type { HaCalendarEvent } from '../external/homeassistant/homeassistant.schemas.ts';
